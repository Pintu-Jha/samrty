  ...
  return (
    <>
      ...
      <View style={styles.filterContainer}>
        ...
        {/* <TextInput
            placeholder="Mobile"
            placeholderTextColor={isDarkMode ? Colors.dark.black : Colors.light.white}
        ...
        <CustomInput
          ...
          placeholder="Mobile"
          placeholderColor={isDarkMode ? Colors.dark.black : Colors.light.white}
          value={filters.mobile}
          onChange={handleMobileChange}
          maxLength={10}
          type="numeric"
